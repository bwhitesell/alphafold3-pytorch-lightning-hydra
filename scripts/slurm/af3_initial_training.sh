...
export SINGULARITY_CONTAINER="/scratch/pawsey1018/$USER/af3-pytorch-lightning-hydra/af3-pytorch-lightning-hydra_0.4.37_dev.sif"
...
srun -c 64 singularity exec \
    ...
    bash -c "
        python3 -m pip install deepspeed==0.15.1 git+https://github.com/wandb/wandb.git@41c9cb0cee6f763931045c25bf2fbdba32699575
