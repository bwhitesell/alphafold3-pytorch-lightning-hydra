...
#SBATCH -J af3_overfitting_e2_bs1 # job name
...
srun python3 alphafold3_pytorch/train.py \
    ...
    +logger.wandb.name=AlphaFold3-31M-Overfit-E2-BS1-08222024 \
    model=alphafold3 \
    ...
    +model.net.msa_module_kwargs='{depth: 2, dim_msa: 32}' \
    +model.net.pairformer_stack='{depth: 6, pair_bias_attn_dim_head: 32, pair_bias_attn_heads: 8}' \
