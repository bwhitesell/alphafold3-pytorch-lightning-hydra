...
######################### Batch Headers #########################
#SBATCH --partition=gpu                                       # use reserved partition `chengji-lab-gpu`
...
#SBATCH -t 02-00:00:00                                        # time limit for the job (up to 2 days: `02-00:00:00`)
#SBATCH -J af3_initial_training_general                       # job name
...
# Define WandB run ID
RUN_ID="rftfykma" # NOTE: Generate a unique ID for each run using `python3 scripts/generate_id.py`
